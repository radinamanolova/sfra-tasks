...
describe('Store Locator', function () {
    ...
    describe('FindStores using Postal Code and radius', function () {
        it('should returns locations for valid postal code and radius', function () {
        ...
        it('should returns location for specified postal code and default radius = 15', function () {
            ...
            request(myRequest, function (error, response) {
                ...
                var bodyAsJson = JSON.parse(response.body);
                assert.containSubset(bodyAsJson.stores, ExpectedResBody.stores, 'Actual response.stores not as expected.');
                assert.containSubset(bodyAsJson.locations, ExpectedResBody.locations, 'Actual response.locations not as expected.');
                assert.containSubset(bodyAsJson.radius, ExpectedResBody.radius, 'Actual response.radius not as expected.');
            });
        });

        it('should returns 0 location for non-exist postal code', function () {
        ...
        it('should returns 0 location for negative radius', function () {
            var url = config.baseUrl + '/Stores-FindStores?postalCode=01803&radius=-15';
            var myRequest = {
                url: url,
                method: 'GET',
    ...
    describe('FindStores using valid longitude, latitude and radius.', function () {
        it('should returns locations for specified longitude, latitude and radius', function () {
        ...
        it('should returns succesful response with no parameter', function () {
